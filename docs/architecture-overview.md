...
The Speech Layer manages speech policy and output delivery then instructs Speech Dispatcher to synthesize the audio, interrupting any currently playing audio.